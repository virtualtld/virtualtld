...
public class ResourceRecords {
    ...
    public List<ResourceRecord> question = new ArrayList<>();
     ...
     */
    public ResourceRecords(byte[] msg, int msgLen, Header hdr, boolean zoneXfer)
    ...
    int getLastAnsType() {
        ...
        return answer.get(answer.size() - 1).getType();
    }
