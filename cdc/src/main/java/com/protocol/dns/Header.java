...
public class Header {
    ...
    public int xid;                    // ID:  16-bit query identifier
    public boolean query;              // QR:  true if query, false if response
    public int opcode;                 // OPCODE:  4-bit opcode
    public boolean authoritative;      // AA
    public boolean truncated;          // TC
    public boolean recursionDesired;   // RD
    public boolean recursionAvail;     // RA
    public int rcode;                  // RCODE:  4-bit response code
    public int numQuestions;
    public int numAnswers;
    public int numAuthorities;
     ...
     */
    public Header(byte[] msg, int msgLen) throws NamingException {
        decode(msg, msgLen);
    }
